...
export default function DemoPage() {
  ...
  const checkAuthAndAccess = async () => {
    try {
      ...
      const demoData = await demoClientService.getDemoBySlug(slug);
      ...
      const canAccess = await demoClientService.canUserAccessDemo(
        user.id,
        slug
      );
      ...
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            The demo files may not be ready yet.
          </p>
          <a
            href={demoUrl}
            target="_blank"
...
function DemoStatusMessage({ demo }: { demo: DemoProject }) {
    ...
    switch (demo.status) {
      case "building":
        return {
          ...
          message:
            "Your demo is currently being prepared. This usually takes a few minutes.",
          color: "blue",
        };
      case "preparing":
        return {
      ...
      case "error":
        return {
          ...
          message:
            "There was an issue building your demo. Please contact support.",
          color: "red",
        };
      default:
        return {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-50">
      <div className="text-center max-w-md mx-auto p-6">
        <div
          className={`bg-${status.color}-100 rounded-full p-3 w-16 h-16 mx-auto mb-4 flex items-center justify-center`}
        >
          {status.color === "blue" && (
