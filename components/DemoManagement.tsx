...
import { DemoProject, BuildType, getDemoStatusColor, getDemoStatusLabel, getBuildTypeLabel } from '@/lib/types/demo';
...
export default function DemoManagement({ projects }: DemoManagementProps) {
  ...
  const handleDeployDemo = async () => {
    if (!selectedProject || !deployForm.demo_name || !deployForm.local_path) {
    ...
    try {
      ...
      if (data.success) {
        alert('Demo deployed successfully!');
        setShowDeployModal(false);
        setDeployForm({ demo_name: '', build_type: 'static', local_path: '' });
  ...
  const handleDeleteDemo = async (demo: DemoProject) => {
    if (!confirm(`Are you sure you want to delete the demo for "${demo.demo_name}"? This will remove all demo files.`)) {
      return;
    }
    ...
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      {demos.length === 0 ? (
        <div className="p-8 text-center text-gray-500">
          ...
          <p className="mb-4">Deploy demos from your existing projects to showcase your work.</p>
          {getProjectsWithoutDemos().length > 0 && (
            <button
              onClick={() => setShowDeployModal(true)}
              className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{demo.project?.client?.email || 'Unknown client'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="flex items-center justify-between p-6 border-b">
              <h2 className="text-xl font-bold text-gray-900">Deploy New Demo</h2>
              <button
                onClick={() => {
                  setShowDeployModal(false);
                  setSelectedProject(null);
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const project = getProjectsWithoutDemos().find(p => p.id === e.target.value);
                    setSelectedProject(project);
                    if (project) {
                      setDeployForm(prev => ({ ...prev, demo_name: `Demo: ${project.name}` }));
                    }
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDeployForm(prev => ({ ...prev, demo_name: e.target.value }))}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setDeployForm(prev => ({ ...prev, build_type: e.target.value as BuildType }))}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDeployForm(prev => ({ ...prev, local_path: e.target.value }))}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div className="flex items-center justify-end space-x-3 p-6 border-t">
              ...
              <button
                ...
                disabled={deploying || !selectedProject || !deployForm.demo_name || !deployForm.local_path}
